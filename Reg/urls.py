...
urlpatterns = patterns('',
    ...
    url(r'^termsrest/$', restApi.TermsList.as_view()),
    url(r'^termsrest/(?P<pk>\d+)/$', restApi.TermsDetail.as_view()),
    url(r'^encumbrancerest/$', restApi.EncumbranceList.as_view()),
    url(r'^encumbrancerest/(?P<pk>\d+)/$', restApi.EncumbranceDetail.as_view()),
    url(r'^objectrest/$', restApi.ObjectList.as_view()),
    url(r'^objectrest/(?P<pk>\d+)/$', restApi.ObjectDetail.as_view()),
    url(r'^documentbaserest/$', restApi.DocumentBaseList.as_view()),
    url(r'^documentbaserest/(?P<pk>\d+)/$', restApi.DocumentBaseDetail.as_view()),
